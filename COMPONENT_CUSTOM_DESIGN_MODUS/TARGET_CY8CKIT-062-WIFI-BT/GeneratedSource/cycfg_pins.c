...
const cy_stc_gpio_pin_config_t USB_HOST_EN_config = 
{
	.outVal = 1,
	.driveMode = CY_GPIO_DM_STRONG_IN_OFF,
	.hsiom = USB_HOST_EN_HSIOM,
	...
	const cyhal_resource_inst_t USB_HOST_EN_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = USB_HOST_EN_PORT_NUM,
		.channel_num = USB_HOST_EN_PIN,
	};
...
{
	Cy_GPIO_Pin_Init(USB_HOST_EN_PORT, USB_HOST_EN_PIN, &USB_HOST_EN_config);
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&USB_HOST_EN_obj);
#endif //defined (CY_USING_HAL)
